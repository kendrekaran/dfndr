      ...
      <div className="px-global py-section-md">
        <div className="max-w-global mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-col items-center gap-3 text-center">
            ...
            <h2 className="max-w-[13em]">
              Everything{" "}
              <span className="text-[#635BFF]">your ops </span>
              team needs.
            </h2>
            <p className="max-w-[39em] text-black/60">
          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-6 sm:gap-8 lg:gap-12">
            <div className="w-full lg:w-[49%] min-h-[220px] sm:min-h-[280px] lg:min-h-[450px] rounded-2xl sm:rounded-3xl border-2 border-black/10 bg-[#FAFAFA]" />
